package com.daurinpoin.app.ui.scan.helper
...
class ImageClassifierHelper(
    ...
    private val modelName: String = "model_lawas_v1.tflite",
    val context: Context,
    ...
    fun classify(image: ImageProxy) {
        ...
        val imageProcessingOptions = ImageProcessingOptions.builder()
            .setOrientation(getOrientationFromRotation(image.imageInfo.rotationDegrees)).build()
